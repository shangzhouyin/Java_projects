...
public class sorcerers extends heroes{
    public sorcerers(String name, int MP_value, double strength, double agility, double dexterity, int money, int experience_points) {
    ...
    public void favoredLevelUp() {
        super.setStrength(super.getStrength()*1.05);
