...
public class paladins extends heroes{
    ...
    //constructor to initialize paladins' variables
    public paladins(String name, int MP_value, double strength, double agility, double dexterity, int money, int experience_points) {
    ...
    public void favoredLevelUp() {
        ...
        super.setAgility(super.getAgility()*1.05);
        super.setDexterity(super.getDexterity()*1.1);
    }
}
